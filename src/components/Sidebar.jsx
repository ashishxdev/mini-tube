...
const Sidebar = () => {
  ...
  return (
    <div className={`p-5 shadow-lg w-55 h-[calc(100vh-3.5rem)] fixed left-0 top-14 overflow-y-scroll scrollbar-none
    ${isMenuOpen ? "block" : "hidden"}`}>
      <div className='p-1 m-2 text-sm'>
      <ul className="mb-4">
        <li> 
          <div className='flex gap-3 items-center'>
          <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false" aria-hidden="true" className="pointer-events: none; display: inherit; width: 100%; height: 100%; invert"><path clipRule="evenodd" d="M22.146 11.146a.5.5 0 01-.353.854H20v7.5a1.5 1.5 0 01-1.5 1.5H14v-8h-4v8H5.5A1.5 1.5 0 014 19.5V12H2.207a.5.5 0 01-.353-.854L12 1l10.146 10.146Z" fillRule="evenodd"></path></svg>
          <Link to="/">
          Home
          </Link>
          </div>
