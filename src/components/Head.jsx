  ...
  return (
    <div className='grid grid-flow-col px-4 p-1 my-2 mx-auto shadow-lg items-center sticky top-0 w-[98vw] bg-[#0f0f0f] z-50 rounded-lg'>
      <div className='flex col-span-1 items-center cursor-pointer gap-3 md:gap-3'>
        ...
        <a href="/">
          <svg xmlns="http://www.w3.org/2000/svg" id="yt-ringo2-svg_yt9" width="110" height="20" viewBox="0 0 93 20" focusable="false" aria-hidden="true" className="pointer-events: none; display: inherit; w-16 h-6 md:w-full md:h-full">
            <g>
