    ...
    <div className='grid grid-flow-col px-4 p-1 my-2 mx-auto shadow-lg items-center sticky top-0 w-[98vw] bg-[#0f0f0f] z-50 rounded-lg'>
      <div className='flex col-span-1 items-center cursor-pointer gap-3 md:gap-3'>
        ...
        <a href="/">
          ...
          <path d="M74.8 18.9V8.5H72V6.5H74.8V4.5C74.8 2.3 76 1 78.2 1C78.9 1 79.5 1.1 80 1.2V3.1C79.6 3 79.2 3 78.8 3C77.9 3 77.4 3.5 77.4 4.5V6.5H80V8.5H77.4V18.9H74.8Z" fill="white"></path>
          <path d="M82 18.9V6.5H84.3V8H84.4C84.8 7.1 85.7 6.3 87.1 6.3C89.1 6.3 90.3 7.6 90.3 9.8V18.9H87.7V10.4C87.7 9.3 87.2 8.7 86.2 8.7C85.2 8.7 84.6 9.4 84.6 10.5V18.9H82Z" fill="white"></path>
          ...
          <path d="M104 15.1V14.9C104 12.2 105.4 10.3 107.7 10.3C110 10.3 111.4 12.2 111.4 14.9V15.6H106.6C106.7 16.8 107.3 17.5 108.3 17.5C109.1 17.5 109.6 17.1 109.7 16.5H111.3C111.1 18 110 19.1 108.3 19.1C105.9 19.1 104 17.5 104 14.7V15.1ZM106.6 14.2H108.8C108.7 13.1 108.2 12.5 107.2 12.5C106.2 12.5 105.7 13.1 105.6 14.2H106.6Z" fill="white"></path>
          </g>
          </svg>
        </a>
      </div>
