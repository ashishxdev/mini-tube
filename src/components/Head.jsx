...
<!-- b (like d but mirror) -->
<path d="M93 1H95.6V6.5H95.7C96 5.9 96.4 5.5 96.9 5.2C97.4 4.9 98 4.8 98.6 4.8C99.6 4.8 100.4 5.2 101 5.9C101.6 6.6 101.9 7.6 101.9 8.9V14.1C101.9 15.4 101.6 16.4 101 17.1C100.4 17.8 99.6 18.2 98.6 18.2C98 18.2 97.4 18.1 96.9 17.8C96.4 17.5 96 17.1 95.7 16.5H95.6V18.9H93V1ZM95.6 8.9C95.6 8.1 95.8 7.5 96.2 7.1C96.6 6.7 97.1 6.5 97.7 6.5C98.3 6.5 98.8 6.7 99.2 7.1C99.6 7.5 99.8 8.1 99.8 8.9V14.1C99.8 14.9 99.6 15.5 99.2 15.9C98.8 16.3 98.3 16.5 97.7 16.5C97.1 16.5 96.6 16.3 96.2 15.9C95.8 15.5 95.6 14.9 95.6 14.1V8.9Z" fill="white" fill-rule="evenodd"></path>
