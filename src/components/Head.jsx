    ...
    <div className='grid grid-flow-col px-4 p-1 my-2 mx-auto shadow-lg items-center sticky top-0 w-[98vw] bg-[#0f0f0f] z-50 rounded-lg'>
      <div className='flex col-span-1 items-center cursor-pointer gap-3 md:gap-3'>
        ...
        <a href="/">
          ...
          <path d="M82 6.5V15.3C82 16 82.2 16.5 82.6 16.9C83 17.3 83.6 17.5 84.3 17.5C85 17.5 85.6 17.3 86 16.9C86.4 16.5 86.6 16 86.6 15.3V6.5H89.2V15.3C89.2 16.8 88.8 17.9 88 18.7C87.2 19.5 86 19.9 84.3 19.9C82.6 19.9 81.4 19.5 80.6 18.7C79.8 17.9 79.4 16.8 79.4 15.3V6.5H82Z" fill="white"></path>
          ...
          <path d="M104 14.5V14.3C104 11.8 105.3 10.1 107.5 10.1C109.7 10.1 111 11.8 111 14.3V14.9H106.5C106.6 16 107.2 16.6 108.1 16.6C108.8 16.6 109.3 16.3 109.4 15.8H110.9C110.7 17.2 109.7 18.2 108.1 18.2C105.9 18.2 104 16.7 104 14.1V14.5ZM106.5 13.7H109.4C109.3 12.7 108.8 12.2 107.9 12.2C107 12.2 106.6 12.7 106.5 13.7Z" fill="white"></path>
          </g>
          </svg>
        </a>
      </div>
