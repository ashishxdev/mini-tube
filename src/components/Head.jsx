    ...
    <div className='grid grid-flow-col px-4 p-1 my-2 mx-auto shadow-lg items-center sticky top-0 w-[98vw] bg-[#0f0f0f] z-50 rounded-lg'>
      <div className='flex col-span-1 items-center cursor-pointer gap-3 md:gap-3'>
        ...
        <a href="/">
          ...
          <path d="M82 6.5V15C82 15.8 82.2 16.4 82.7 16.8C83.2 17.2 83.8 17.4 84.6 17.4C85.4 17.4 86 17.2 86.5 16.8C87 16.4 87.2 15.8 87.2 15V6.5H89.8V15C89.8 16.5 89.4 17.6 88.6 18.4C87.8 19.2 86.6 19.6 84.6 19.6C82.6 19.6 81.4 19.2 80.6 18.4C79.8 17.6 79.4 16.5 79.4 15V6.5H82Z" fill="white"></path>
          ...
          <path d="M103 12.7C103 11.4 103.3 10.4 103.9 9.7C104.5 9 105.3 8.6 106.3 8.6C107.3 8.6 108.1 9 108.7 9.7C109.3 10.4 109.6 11.4 109.6 12.7V13C109.6 14.3 109.3 15.3 108.7 16C108.1 16.7 107.3 17.1 106.3 17.1C105.3 17.1 104.5 16.7 103.9 16C103.3 15.3 103 14.3 103 13V12.7ZM105.6 13C105.6 13.8 105.7 14.4 106 14.8C106.3 15.2 106.7 15.4 107.3 15.4C107.9 15.4 108.3 15.2 108.6 14.8C108.9 14.4 109 13.8 109 13V12.7C109 11.9 108.9 11.3 108.6 10.9C108.3 10.5 107.9 10.3 107.3 10.3C106.7 10.3 106.3 10.5 106 10.9C105.7 11.3 105.6 11.9 105.6 12.7V13Z" fill="white"></path>
          </g>
          </svg>
        </a>
      </div>
