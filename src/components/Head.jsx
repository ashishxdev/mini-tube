    ...
    <div className='grid grid-flow-col px-4 p-1 my-2 mx-auto shadow-lg items-center sticky top-0 w-[98vw] bg-[#0f0f0f] z-50 rounded-lg'>
      <div className='flex col-span-1 items-center cursor-pointer gap-3 md:gap-3'>
        ...
        <a href="/">
          ...
          <path d="M82 18.9V6.5H84.3V8H84.4C84.7 7.4 85.1 6.9 85.6 6.6C86.1 6.3 86.7 6.2 87.3 6.2C88.3 6.2 89.1 6.5 89.6 7.1C90.1 7.7 90.4 8.6 90.4 9.8V18.9H87.8V10.4C87.8 9.8 87.7 9.4 87.4 9.1C87.1 8.8 86.7 8.7 86.2 8.7C85.7 8.7 85.3 8.9 84.9 9.3C84.5 9.7 84.3 10.2 84.3 10.9V18.9H82Z" fill="white"></path>
          ...
          <path d="M104 12.7C104 11.4 104.3 10.4 104.9 9.7C105.5 9 106.3 8.6 107.3 8.6C108.3 8.6 109.1 9 109.7 9.7C110.3 10.4 110.6 11.4 110.6 12.7V13C110.6 14.3 110.3 15.3 109.7 16C109.1 16.7 108.3 17.1 107.3 17.1C106.3 17.1 105.5 16.7 104.9 16C104.3 15.3 104 14.3 104 13V12.7ZM106.6 13C106.6 13.8 106.7 14.4 107 14.8C107.3 15.2 107.7 15.4 108.3 15.4C108.9 15.4 109.3 15.2 109.6 14.8C109.9 14.4 110 13.8 110 13V12.7C110 11.9 109.9 11.3 109.6 10.9C109.3 10.5 108.9 10.3 108.3 10.3C107.7 10.3 107.3 10.5 107 10.9C106.7 11.3 106.6 11.9 106.6 12.7V13Z" fill="white"></path>
          </g>
          </svg>
        </a>
      </div>
