    ...
    <div className='grid grid-flow-col px-4 p-1 my-2 mx-auto shadow-lg items-center sticky top-0 w-[98vw] bg-[#0f0f0f] z-50 rounded-lg'>
      <div className='flex col-span-1 items-center cursor-pointer gap-3 md:gap-3'>
        ...
        <a href="/">
          ...
          <path d="M82 18.9V6.5H84.6V18.9H82ZM82 15.5V10C82 9.2 82.2 8.6 82.6 8.2C83 7.8 83.6 7.6 84.3 7.6C85 7.6 85.6 7.8 86 8.2C86.4 8.6 86.6 9.2 86.6 10V15.5C86.6 16.3 86.4 16.9 86 17.3C85.6 17.7 85 17.9 84.3 17.9C83.6 17.9 83 17.7 82.6 17.3C82.2 16.9 82 16.3 82 15.5Z" fill="white"></path>
          ...
          <path d="M101 12.7C101 11.4 101.3 10.4 101.9 9.7C102.5 9 103.3 8.6 104.3 8.6C105.3 8.6 106.1 9 106.7 9.7C107.3 10.4 107.6 11.4 107.6 12.7V13C107.6 14.3 107.3 15.3 106.7 16C106.1 16.7 105.3 17.1 104.3 17.1C103.3 17.1 102.5 16.7 101.9 16C101.3 15.3 101 14.3 101 13V12.7ZM103.6 13C103.6 13.8 103.7 14.4 104 14.8C104.3 15.2 104.7 15.4 105.3 15.4C105.9 15.4 106.3 15.2 106.6 14.8C106.9 14.4 107 13.8 107 13V12.7C107 11.9 106.9 11.3 106.6 10.9C106.3 10.5 105.9 10.3 105.3 10.3C104.7 10.3 104.3 10.5 104 10.9C103.7 11.3 103.6 11.9 103.6 12.7V13Z" fill="white"></path>
          </g>
          </svg>
        </a>
      </div>
